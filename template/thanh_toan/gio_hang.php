            ...
            <form method="POST">
                            ...
                            <div class="item cart-item-line" data-inview-showup="showup-translate-up">
                                <div class="item-image">
                                    <div class="responsive-1by1">
                                        <img src="upload/images/<?= $sanphamgiohang['hinh_anh'] ?>" alt="" />
                                    </div>
                                </div>
                                <div class="item-name">
                ...
                <div class="row cols-md rows-md offs-xl" data-inview-showup="showup-translate-up">
                    ...
                    <div class="md-col-3 md-push-6 sm-col-12">
                        <a href="san-pham" class="btn btns-bordered text-upper col-12">Tiếp tục mua sắm</a>
                    </div>
                </div>
            </form>
            ...
            setTimeout(function () {
                ...
                $.post('api/cap_nhat_so_luong.php', {
                    ...
                    if (response.success) {
                        ...
                        $('#tong-tien').text(response.cart_total + '₫');
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (response.reload) {
                        ...
                        $('#tong-tien').text(newTotal.toLocaleString() + '₫');
                        // $('#tong-tien').text(response.cart_total + '₫');
