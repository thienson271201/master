<div class="overlay">
    <div class="notification">
      ...
      <img style="height: 100%;" src="https://img.vietqr.io/image/OCB-CASS101010-compact2.png?amount=<?= $_POST['tong_tien'] ?>&accountName=profix&addInfo=thanh toan don hang <?= $_POST['ma_don_hang'] ?>" alt="">
