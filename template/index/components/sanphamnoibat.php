  ...
  <div class="container">
    ...
    <div class="pos-relative">
          ...
          <div class="item shop-item shop-item-short item-dash-border" data-inview-showup="showup-scale">
            ...
            <div class="item-content text-center">
              <div class="item-title text-upper mb-0">
                <a href="<?= $noi_bat['duong_dan'] ?>" class="content-link"><?= $noi_bat['ten_san_pham'] ?></a>
              </div>
              <div class="item-prices">
                <div class="item-price"><?= number_format($noi_bat["gia_sau_khuyen_mai"], 0, ',', '.') ?> ₫</div>
              </div>
              <div class="item-links">
                <a href="#" data-id="<?= $noi_bat['id'] ?>" class="btn-add-to-cart btn btn-sm px-2 mx-2 btns-bordered"><i
                    class="fas fa-shopping-cart"></i></a>
                <a href="#" class="btn btn-sm px-2 mx-2 btns-bordered"><i class="fas fa-heart"></i></a>
              </div>
            </div>
          </div>
        <?php endforeach; ?>
      ...
      <div class="section-footer-nav-over text-center">
        <div class="owl-custom-navigation owl-nav-bordered" data-inview-showup="showup-translate-left"></div>
      </div>
    </div>
  </div>
</section>
