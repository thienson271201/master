           ...
           <?php endforeach; ?>
            ...
            >
              ...
              <div class="item-content text-center">
                <div class="item-title text-upper mb-0">
                  <a href="shop-item.html" class="content-link"
                    >Laptop ACER Gaming Aspire 7 A715-76G-59MW (i5-12450H/ RAM
                    8GB/ GeForce RTX™ 2050/ 512GB SSD/ Windows 11)</a
                  >
                </div>
                <div class="item-prices">
                  <div class="item-price">19.000.000₫</div>
                  <div class="item-old-price">19.990.000₫</div>
                </div>
                <div class="item-links">
                  <a href="#" class="btn btn-sm px-2 mx-2 btns-bordered"
                    ><i class="fas fa-shopping-cart"></i
            ...
            >
              ...
              <div class="item-content text-center">
                ...
                <div class="item-prices">
                  <div class="item-price">19.990.000₫</div>
                </div>
                <div class="item-links">
                  <a href="#" class="btn btn-sm px-2 mx-2 btns-bordered"
                    ><i class="fas fa-shopping-cart"></i
