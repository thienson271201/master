<div id="gio_hang_component" class="block-cart collapse" data-block="cart"
    data-show-block-class="animation-scale-top-right" data-hide-block-class="animation-unscale-top-right">
                            ...
                            <div class="shop-side-item cart-item">
                                ...
                                <div class="item-side-image">
                                    <a href="shop-item.html" class="item-image responsive-1by1"><img
                                            src="upload/images/<?= $giohanghover['hinh_anh'] ?>" alt="" /></a>
                                </div>
                                <div class="item-side">
                                    <div class="item-title">

                                        <a href="shop-item.html"
                                            class="content-link text-upper"><?= $giohanghover['ten_san_pham'] ?></a>
                                    </div>
                                    <div class="item-quantity">Số lượng: <?= $item['quantity'] ?></div>
                                    <div class="item-prices">
                                        <div class="item-price"><?= $f->format_tiente($giohanghover['gia_sau_khuyen_mai']) ?> đ
                                        </div>
