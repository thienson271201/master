...
(function (global, factory) {
  ...
  class PushMenu {
    ...
    menusClose() {
      ...
      const navItem =
        navSidebar === null || navSidebar === void 0
          ? void 0
          : navSidebar.querySelectorAll(SELECTOR_NAV_ITEM$1);
      if (navItem) {
    ...
    addSidebarBreakPoint() {
      ...
      const sidebarExpandList =
        (_b =
          (_a = document.querySelector(SELECTOR_SIDEBAR_EXPAND)) === null ||
          _a === void 0
            ? void 0
          ...
          : [];
      const sidebarExpand =
        (_c = Array.from(sidebarExpandList).find((className) =>
          className.startsWith(CLASS_NAME_SIDEBAR_EXPAND)
        )) !== null && _c !== void 0
          ? _c
          : "";
      const sidebar = document.getElementsByClassName(sidebarExpand)[0];
      const sidebarContent = window
  ...
  onDOMContentLoaded(() => {
    ...
    const sidebar =
      document === null || document === void 0
        ? void 0
        : document.querySelector(SELECTOR_APP_SIDEBAR);
    if (sidebar) {
    ...
    (_a = document.querySelector(SELECTOR_APP_WRAPPER)) === null ||
    _a === void 0
      ? void 0
      : _a.append(sidebarOverlay);
      ...
      btn.addEventListener("click", (event) => {
        ...
        if (
          (button === null || button === void 0
            ? void 0
            : button.dataset.lteToggle) !== "sidebar"
        ) {
          button =
            button === null || button === void 0
              ? void 0
              : button.closest(SELECTOR_SIDEBAR_TOGGLE);
        }
        if (button) {
  ...
  class Treeview {
    ...
    open() {
      ...
      if (this._config.accordion) {
        const openMenuList =
          (_a = this._element.parentElement) === null || _a === void 0
            ? void 0
            : _a.querySelectorAll(
                `${SELECTOR_NAV_ITEM}.${CLASS_NAME_MENU_OPEN}`
              );
              ...
              if (openMenu !== this._element.parentElement) {
                ...
                const childElement =
                  openMenu === null || openMenu === void 0
                    ? void 0
                    : openMenu.querySelector(SELECTOR_TREEVIEW_MENU);
                if (childElement) {
      ...
      const childElement =
        (_b = this._element) === null || _b === void 0
          ? void 0
          : _b.querySelector(SELECTOR_TREEVIEW_MENU);
      if (childElement) {
    ...
    close() {
      ...
      const childElement =
        (_a = this._element) === null || _a === void 0
          ? void 0
          : _a.querySelector(SELECTOR_TREEVIEW_MENU);
      if (childElement) {
        slideUp(childElement, this._config.animationSpeed);
      }
      this._element.dispatchEvent(event);
    ...
    button.forEach((btn) => {
      btn.addEventListener("click", (event) => {
        ...
        if (
          ...
          (targetLink === null || targetLink === void 0
            ? void 0
  ...
  class CardWidget {
    ...
    toggle() {
      ...
      if (
        (_a = this._parent) === null || _a === void 0
          ? void 0
          : _a.classList.contains(CLASS_NAME_COLLAPSED)
      ) {
        this.expand();
        return;
      }
        ...
        setTimeout(() => {
          ...
          if (this._parent) {
            ...
            if (
              (_a = this._parent) === null || _a === void 0
                ? void 0
                : _a.classList.contains(CLASS_NAME_WAS_COLLAPSED)
            ) {
    ...
    toggleMaximize() {
      ...
      if (
        (_a = this._parent) === null || _a === void 0
          ? void 0
          : _a.classList.contains(CLASS_NAME_MAXIMIZED)
      ) {
        this.minimize();
        return;
      }
  ...
  const SELECTOR_MAXIMIZE_ICON = '[data-lte-icon="maximize1"]';
  const SELECTOR_MINIMIZE_ICON = '[data-lte-icon="minimize1"]';
  /**
   * Class Definition.
   * ============================================================================
   */
